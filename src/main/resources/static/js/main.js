    ...
    function mainEditorTable() {
        ...
        for (let i = 0; i < 1; i++) {
            mainEditor_content.innerHTML +=
                '<span class="title"><a href="/login/login.jsp">[에디터 칼럼] 너나들이 기능 소개</a></span>' +
                '<span class="content_img"><a href="/login/login.jsp"><img src="/img/main_news.png" style="height:100px;display: block;margin: 80px auto;"></a></span>' +
...
function saying(){
    const words = ['인생은 가까이서 보면 비극이지만 멀리서 보면 희극이다.<br>-찰리채플린-',
        '때로는 살아있는 것조차도 용기가 될 때가 있다.<br>-세네카-',
        '서로를 용서하는 것이야 말로 가장 아름다운 사랑의 모습이다.<br>-존 셰필드-',
        '자신을 화나게 했던 행동을 다른 이에게 행하지 말라<br>-소크라테스-',
        '행동의 가치는 그 행동을 끝까지 이루는 데 있다.<br>-칭기즈탄-',
        '현명한 자라면 찾아낸 기회보다 더 많은 기회를 만들 것이다.<br>-프랜시스 베이컨-',
        '성공은 열심히 노력하며 기다리는 사람에게 찾아온다.<br>-토마스 A. 에디슨-',
        '한 인간의 가치는 그가 무엇을 받을 수 있느냐가 아니라 무엇을 주느냐로 판단된다.<br>-알버트 아인슈타인-',
        '천재란 자신에게 주어진 일을 하는 재능 있는 사람일 뿐이다.<br>-토마스 A. 에디슨-',
        '믿음이 부족하기 때문에 도전하길 두려워하는 바, 나는 스스로를 믿는다.<br>-무하마드 알리-',
        '어디를 가든지 마음을 다해 가라<br>-공자-',
        '낮에 꿈꾸는 사람은 밤에만 꿈꾸는 사람에게는 찾아오지 않는 많은 것을 알고 있다.<br>-에드거 앨런 포-',
        '어떤 일을 하기에 앞서 스스로 그 일에 대한 기대를 가져야 한다.<br>-마이클 조던-',
        '그 어떤 것에서라도 내적인 도움과 위안을 찾을 수 있다면 그것을 잡아라<br>-마하트마 간디-',
        '미래의 가장 좋은 점은 한 번에 하루씩 온다는 것이다.<br>-에이브러햄 링컨-',
        '미래는 여기 있다. 아직 널리 퍼지지 않았을 뿐이다.<br>-윌리엄 깁슨-',
        '당신을 만나는 모든 사람이 당신과 헤어질 때는 더 나아지고 더 행복해질 수 있도록 하라<br>-마더 테레사-',
        '인간의 감정은 누군가를 만날 때와 헤어질 때 가장 순수하며 가장 빛난다.<br>-장 폴 리히터-',
        '나는 삶을 변화시키는 아이디어를 항상 책에서 얻었다.<br>-벨 훅스-',
        '모두를 사랑하되, 몇 사람만 믿으라. 누구에게도 잘못을 저지르지 말라<br>-윌리엄 셰익스피어-'
    ];
