...
<head>
    <script>
        ...
        function recommentInsertForm(comment_seq){
            ...
            a+='<span class="input-group-btn"><button class="btn btn-default" type="button" class="float-right" onclick="reCommentInsert('+comment_seq+');">답글달기</button></span>';
            a+='<br>';
            a+='</div>';
        ...
        function commentDelete(comment_seq){
            $.ajax({
                url:'/editorcomment/delete/'+comment_seq,
                type:'GET',
                data:{'edit_num':bno},
                success:function(data){
