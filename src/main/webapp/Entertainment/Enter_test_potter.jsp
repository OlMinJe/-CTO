...
<div class="col-12 potter">
    ...
    <article class="col-12 mb-4 result">
        ...
        <div class="col-12 col-lg-10" style="margin-left: auto; margin-right: auto;">
            ...
            <button id="Enter_page" type="button" class="btn btn-light text-center col-12" onclick="location.href='/Entertainment/Enter_point?stateCode=${stateCode}'">포인트 적립하기!</button>
        </div>
    </article>
