...
<body>
<div class="map_wrap">
    <div id="map" style="width:100%;height:100%;position:relative;overflow:hidden;"></div><!--지도 크기 설정 변경 필수-->
    <!--지도 검색 컨트롤 div-->
...
<script type="text/javascript" src="/js/map.js"></script> <!--js파일 불러오지 못함 - 이유는??-->
