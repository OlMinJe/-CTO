...
<head>
    <script>
        ...
        function commentDelete(comment_seq){
            $.ajax({
                url:'/talkcomment/delete/'+comment_seq,
                type:'get',
                data:{'talk_num':bno},
                success:function(data){
