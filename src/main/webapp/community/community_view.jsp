            ...
            <div id="like">
                <c:choose>
                    <c:when test="${like_check ==0}">
                        <button type="button" id="likebtn" onclick="window.location.reload();" style="background-image: url('/static/img/heart_icon_3.png');"></button>
                        <%--출처: Heart icons created by Vlad Szirka - Flaticon--%>
                        <input type="hidden" id="likecheck" value="${like_check }">
                    </c:when>
                    <c:when test="${like_check ==1}">
                        <button type="button" id="likebtn" onClick="history.go(0);" style="background-image: url('/static/img/heart_icon_2.png');"></button>
                        <%--출처:Heart icons created by Vlad Szirka - Flaticon--%>
                        <input type="hidden" id="likecheck" value="${like_check }">
                    </c:when>
                </c:choose>
